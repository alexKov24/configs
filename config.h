...
static Key keys[] = {
	...
	{ MODKEY,			XK_r,		spawn,		SHCMD(TERMINAL "lftest") },
...
// switched two last collumns between mpc and .i=+1 so that mod comma would switch screen
	...
	{ MODKEY,			XK_F1,		spawn,		SHCMD("passmenu") },
...
/*	{ MODKEY,			XK_F8,		spawn,		SHCMD("mw -Y") }, */
	{ MODKEY,			XK_F8,		spawn,		SHCMD("trem-dmenuselect") },
